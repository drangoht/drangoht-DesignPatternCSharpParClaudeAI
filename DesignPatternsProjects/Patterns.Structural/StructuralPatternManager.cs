...
{
    /// <summary>
    /// Gestionnaire des patterns structuraux
    /// </summary>
    public class StructuralPatternManager
    {
        private readonly List<IPatternTest> _patterns = new List<IPatternTest>();

        /// <summary>
        /// Constructeur qui découvre et instancie tous les patterns structuraux disponibles
        /// </summary>
        public StructuralPatternManager()
        {
            DiscoverPatterns();
        }

        /// <summary>
        /// Découvre et instancie tous les patterns structuraux disponibles
        /// </summary>
        ...
        /// <summary>
        /// Retourne la liste de tous les patterns structuraux disponibles
        /// </summary>
        ...
        /// <summary>
        /// Exécute un pattern structural spécifique
        /// </summary>
